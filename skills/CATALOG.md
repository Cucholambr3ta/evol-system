...
| [evol-minimal](file:///home/alejandro/Documentos/Desarrollos/personal/evol-dd/skills/evol-minimal/SKILL.md) | quality-gate | `/minimal` | Anti-over-engineering enforcer. Decision ladder + niveles lite/full/ultra/off. Guardrails nunca se recortan. Inspirada en ponytail. |
...
| [evol-context7](file:///home/alejandro/Documentos/Desarrollos/personal/evol-dd/skills/evol-context7/SKILL.md) | research | `/context7` | Inyeccion de documentacion version-specific y actualizada de librerias/frameworks al contexto del agente via Context7 (MCP server o CLI ctx7). Elimina APIs alucinadas, ejemplos obsoletos y respuestas genericas cuando se trabaja con versiones nuevas fuera del knowledge cutoff. Usar al fijar contratos de |
...
| [evol-frontend-design](file:///home/alejandro/Documentos/Desarrollos/personal/evol-dd/skills/evol-frontend-design/SKILL.md) | growth | `/frontend-design` | Diseno de interfaces frontend production-grade que evitan la estetica generica de "AI slop". Fase de design-thinking ANTES de codear, sistema de design tokens, y dos perfiles esteticos seleccionables (bold / enterprise-minimal) via evol.profile.yml. Usar cuando se construye UI, componentes, paginas, dashboards, |
...
| [evol-remotion](file:///home/alejandro/Documentos/Desarrollos/personal/evol-dd/skills/evol-remotion/SKILL.md) | growth | `/remotion` | Creacion programatica de motion y video en React con Remotion (useCurrentFrame, interpolate, Sequence). Es la capa de diseno dinamico/animado del toolkit de diseno de Evol-DD, complementaria a evol-frontend-design (estatica). Usar al construir UI con animacion, transiciones, reveals, hero animations, demos de |
...
- **[evol-frontend-design](file:///home/alejandro/Documentos/Desarrollos/personal/evol-dd/skills/evol-frontend-design/SKILL.md)**: Diseno de interfaces frontend production-grade que evitan la estetica generica de "AI slop". Fase de design-thinking ANTES de codear, sistema de design tokens, y dos perfiles esteticos seleccionables (bold / enterprise-minimal) via evol.profile.yml. Usar cuando se construye UI, componentes, paginas, dashboards,
- **[evol-remotion](file:///home/alejandro/Documentos/Desarrollos/personal/evol-dd/skills/evol-remotion/SKILL.md)**: Creacion programatica de motion y video en React con Remotion (useCurrentFrame, interpolate, Sequence). Es la capa de diseno dinamico/animado del toolkit de diseno de Evol-DD, complementaria a evol-frontend-design (estatica). Usar al construir UI con animacion, transiciones, reveals, hero animations, demos de
...
- **[evol-context7](file:///home/alejandro/Documentos/Desarrollos/personal/evol-dd/skills/evol-context7/SKILL.md)**: Inyeccion de documentacion version-specific y actualizada de librerias/frameworks al contexto del agente via Context7 (MCP server o CLI ctx7). Elimina APIs alucinadas, ejemplos obsoletos y respuestas genericas cuando se trabaja con versiones nuevas fuera del knowledge cutoff. Usar al fijar contratos de
